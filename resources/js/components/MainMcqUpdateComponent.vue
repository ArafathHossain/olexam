      ...
      <div class="col-md-10 mx-auto">
        <div class="olm_questions_form">
            ...
            <div class="card">
              <div class="card-body pb-0">
                      ...
                      <div class="col-md-2">
                        <div v-if="fields.ans_mode == false">
                          ...
                          >
                            ...
                            <div
                              class="ques_title_photo"
                              @click="emove_ans_option_photo(main_index, index)"
                            >
                              <i class="fas fa-times"></i>
                            </div>
                          </div>
                ...
                <div class="card-footer show_on_focus pl-0">
                  <div class="form-group small-quill">
                    <quill-editor
          ...
          <div class="col-md-6 mx-auto text-center pt-2">
            <button
              type="submit"
              class="btn btn-primary mx-auto sm"
              @click="save_fields"
            >
...
export default {
  ...
  methods: {
    ...
    done_answer: function (index) {
      this.form_fields[index].ans_mode = false;
    },
    clicked() {
    ...
    get_ques_title_photo: function (main_index, option = "") {
      let photo =
        this.form_fields[main_index].questions_photo.length > 100
          ? this.form_fields[main_index].questions_photo
          : this.base_url + "/" + this.form_fields[main_index].questions_photo;
    ...
    save_fields: function () {
      ...
      axios
        .post(this.base_url + "/admin/main-mcqs/" + this.id, formData)
        .then((response) => {
  ...
  mounted() {
    let ids = this.db_id.split("||");
    this.dynamic_id = ids[0];
    this.option_dy_id = ids[1];
    this.form_fields = this.row_mcq;
    this.ajax_subject();
  },
};
</script>
