    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Update About</h1>
...
<div class="card mb-4">
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h6 class="fs-17 font-weight-600 mb-0">Update About</h6>
            </div>
            ...
            <form action="{{ route('admin.abouts.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <img src="{{ asset($data->photo) }}" alt="" width="100px">
                    </div>
                </div>
                @php
                $icon = explode('||', $data->list_icon);
                $title = explode('||', $data->list_title);
                $content = explode('||', $data->list_content);
                @endphp
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('list_title') ? 'is-invalid' : '' }}"
                                id="list_title" aria-describedby="emailHelp"
                                name="list_title[]" value="{{ !empty($title[$key]) ? $title[$key] : '' }}">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control {{ $errors->has('list_content') ? 'is-invalid' : '' }}"
                                name="list_content[]" id="list_content">{{ !empty($content[$key]) ? $content[$key] : '' }}</textarea>
