    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Update Coupon</h1>
                <small>Update Coupon Here</small>
            </div>
        </div>
    </div>
</div>
...
<div class="card mb-4">
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h6 class="fs-17 font-weight-600 mb-0">Update Coupon</h6>
            </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('discount') ? 'is-invalid' : '' }}"
                                id="discount" name="discount" value="{{ $coupon->discount }}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('date') ? 'is-invalid' : '' }}"
                                id="date" name="date" value="{{ $coupon->date }}">
                            @if ($errors->has('date'))
                            <div class="text-danger">
                                {{ $errors->first('date') }}
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('user') ? 'is-invalid' : '' }}"
                                id="user" name="user" value="{{ $coupon->user }}">
                            @if ($errors->has('user'))
                            <div class="text-danger">
                                {{ $errors->first('user') }}
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('min_buy') ? 'is-invalid' : '' }}"
                                id="min_buy" name="min_buy" value="{{ $coupon->min_buy }}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control basic-single" name="student_class_id" id="student_class_id">
                                ...
                                <option value="{{ $class->id }}" {{ $coupon->student_class_id == $class->id ? 'selected' : '' }} >
