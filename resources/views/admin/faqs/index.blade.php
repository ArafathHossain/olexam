    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">All Faqs</h1>
...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('admin.faqs.create') }}" class="btn btn-success rounded-pill w-100p mb-2 mr-1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @endcan
                                @can('can-delete')
                                <form action="{{ route('admin.faqs.destroy', $data->id) }}" method="POST"
                                    class="d-inline">
