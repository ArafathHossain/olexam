    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Update Page</h1>
...
<div class="card mb-4">
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h6 class="fs-17 font-weight-600 mb-0">Update Page</h6>
            </div>
            ...
            <form action="{{ route('admin.pages.update', $page->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group ">
                    ...
                    <textarea name="content" id="content" rows="4" placeholder="Description..."
                        class="form-control {{ $errors->has('content') ? 'is-invalid' : '' }}">{!! Request::old('content', $page->content) !!}</textarea>
