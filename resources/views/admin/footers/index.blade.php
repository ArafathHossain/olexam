    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">All Footer Menu</h1>
...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('admin.footers.create') }}" class="btn btn-success rounded-pill w-100p mb-2 mr-1">
            ...
            <div class="table-responsive">
                <table class="table display table-bordered table-striped table-hover basic">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="6" class="text-center"> {{ word_view($key) }}</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>{{ word_view($foot->column) }}</td>
                            <td>
                                {{$foot->title}}
                            </td>
                            <td>
                                @php
                                $menus = explode('||',$foot->name)
                                @endphp
                                <ul>
                            ...
                            <td>
                                ...
                                @can('can-edit')
                                <a href="{{ route('admin.footers.edit', $foot->id) }}"
                                    class="btn btn-info-soft btn-sm mr-1"><i class="far fa-edit"></i></a>
                                @endcan
                                @can('can-delete')
                                <form action="{{ route('admin.footers.destroy', $foot->id) }}" method="POST"
                                    class="d-inline">
