        ...
        <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6 col-sm-12">
                <div class="sec-heading center">
                    ...
                    <h2><span class="theme-cl">Hot & Popular</span> Categories for Online MCQ Exams</h2>
                </div>
            </div>
        </div>
...
<!-- <section style="background: url( {{ asset('images/testimonial.png')}} )">
				<div class="container">
					...
					<div class="row">
						<div class="col-md-12">
							<div id="testimonials_style" class="slick-carousel-3 arrow_middle slick-initialized slick-slider"><button type="button" data-role="none" class="slick-prev slick-arrow" aria-label="Previous" role="button" style="display: flex;">Previous</button>
								<div aria-live="polite" class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 7020px; transform: translate3d(-1170px, 0px, 0px);" role="listbox"><div class="testimonial-detail slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" style="width: 1170px;" tabindex="-1">
								...
								</div><div class="testimonial-detail slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" style="width: 1170px;" tabindex="-1" role="option" aria-describedby="slick-slide00">
									<div class="client-detail-box">
										<div class="pic">
								...
								</div><div class="testimonial-detail slick-slide" data-slick-index="1" aria-hidden="true" style="width: 1170px;" tabindex="-1" role="option" aria-describedby="slick-slide01">
									<div class="client-detail-box">
										<div class="pic">
								...
								</div><div class="testimonial-detail slick-slide" data-slick-index="2" aria-hidden="true" style="width: 1170px;" tabindex="-1" role="option" aria-describedby="slick-slide02">
									<div class="client-detail-box">
										<div class="pic">
								...
								</div><div class="testimonial-detail slick-slide" data-slick-index="3" aria-hidden="true" style="width: 1170px;" tabindex="-1" role="option" aria-describedby="slick-slide03">
									<div class="client-detail-box">
										<div class="pic">
											<img src="assets/img/user-4.jpg" alt="">
										</div>
								...
								</div><div class="testimonial-detail slick-slide slick-cloned" data-slick-index="4" aria-hidden="true" style="width: 1170px;" tabindex="-1">
									<div class="client-detail-box">
										<div class="pic">
											<img src="assets/img/user-1.jpg" alt="">
										</div>
							...
							<button type="button" data-role="none" class="slick-next slick-arrow" aria-label="Next" role="button" style="display: flex;">Next</button></div>
						</div>
					</div>
