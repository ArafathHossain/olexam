...
<section class="pt-0 bg-light">
    <div class="container">
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control " rows="2" readonly>{{ $user }}
                                        </textarea>
                            <span class="pt-2 d-inline-block">
                                Correct Answer : <span class="font-weight-bold">{{ $ans }}</span>
            ...
            {{-- <button type="submit" class="btn btn-outline-theme w-100 justify-content-center">Review Answers</button> --}}
        </div>
    </div>
</section>
<!-- ====================================== FAQS =================================== -->
