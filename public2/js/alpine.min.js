...
! function (e, t) {
    ...
    function b(e, t, n, i = !1) {
        ...
        } else r.some(e => ["enter", "enter-start", "enter-end"].includes(e.value)) ? function (e, t, n, i) {
            let r = n => "function" == typeof n ? t.evaluateReturnExpression(e, n) : n;
            const s = p(r((n.find(e => "enter" === e.value) || {
                    expression: ""
                }).expression)),
                o = p(r((n.find(e => "enter-start" === e.value) || {
                    expression: ""
                }).expression)),
                a = p(r((n.find(e => "enter-end" === e.value) || {
                    expression: ""
                }).expression));
            _(e, s, o, a, i, () => {}, h)
        }(e, n, r, t) : t()
    ...
    function y(e, t, n, i = !1) {
        ...
        if (s && s.modifiers.includes("transition")) {
        ...
        } else r.some(e => ["leave", "leave-start", "leave-end"].includes(e.value)) ? function (e, t, n, i) {
            const r = p((n.find(e => "leave" === e.value) || {
                ...
                o = p((n.find(e => "leave-end" === e.value) || {
                    expression: ""
                }).expression);
            _(e, r, s, o, () => {}, i, v)
        }(e, 0, r, t) : t()
    ...
    function x(e, t, n, i, r, s) {
        ...
        const o = e.style.opacity,
            ...
            f = {
                start() {
                    u && (e.style.opacity = r.first.opacity), d && (e.style.transform = `scale(${r.first.scale/100})`)
                },
                during() {
                    d && (e.style.transformOrigin = r.origin), e.style.transitionProperty = [u ? "opacity" : "", d ? "transform" : ""].join(" ").trim(), e.style.transitionDuration = `${r.duration/1e3}s`, e.style.transitionTimingFunction = "cubic-bezier(0.4, 0.0, 0.2, 1)"
                },
                show() {
                    n()
                },
                end() {
                    u && (e.style.opacity = r.second.opacity), d && (e.style.transform = `scale(${r.second.scale/100})`)
                },
                hide() {
                    i()
                },
    ...
    function k(e, t, i, r, o) {
        s(t, "x-for");
        let a = A("function" == typeof i ? e.evaluateReturnExpression(t, i) : i),
            l = function (e, t, n, i) {
                let r = d(t, e, "if")[0];
                if (r && !e.evaluateReturnExpression(t, r.expression)) return [];
                if (E(n.items)) return Array.from(Array(parseInt(n.items, 10)).keys(), e => e + 1);
        ...
        l.forEach((i, s) => {
                ...
                m ? (delete m.__x_for_key, m.__x_for = u, e.updateElements(m, () => m.__x_for)) : (b(m = function (e, t) {
                    let n = document.importNode(e.content, !0);
                    return t.parentElement.insertBefore(n, t.nextElementSibling), t.nextElementSibling
                }(t, c), () => {}, e, r), m.__x_for = u, e.initializeElements(m, () => m.__x_for)), (c = m).__x_for_key = f
            }),
            function (e, t) {
    ...
    function S(e, t, n, r, s, a, l) {
        ...
        if ("value" === n) {
            ...
            if (void 0 === c && r.match(/\./) && (c = ""), "radio" === t.type) void 0 === t.attributes.value && "bind" === a ? t.value = c : "bind" !== a && (t.checked = t.value == c);
            else if ("checkbox" === t.type) "string" == typeof c && "bind" === a ? t.value = c : "bind" !== a && (Array.isArray(c) ? t.checked = c.some(e => e == t.value) : t.checked = !!c);
    ...
    function P(e, t, n, i, r, s = {}) {
        ...
        if (i.includes("camel") && (n = o(n)), i.includes("away")) {
            let o = a => {
                t.contains(a.target) || t.offsetWidth < 1 && t.offsetHeight < 1 || (C(e, r, a, s), i.includes("once") && document.removeEventListener(n, o, l))
            };
                    ...
                    if (o !== window && o !== document || document.body.contains(t)) {
                        if (!(function (e) {
                                ...
                                if (n = n.filter(e => !i.includes(e)), i.length > 0) {
                                    ...
                                    if (t.length === i.length && n[0] === D(e.key)) return !1
                                }
                                return !0
                            }(a, i) || (i.includes("prevent") && a.preventDefault(), i.includes("stop") && a.stopPropagation(), i.includes("self") && a.target !== t))) {
                            C(e, r, a, s).then(e => {
                                !1 === e ? a.preventDefault() : i.includes("once") && o.removeEventListener(n, c, l)
                            })
                        }
    ...
    class de {
        constructor(e) {
            if (this.valueDistortion = ce, this.valueMutated = le, this.valueObserved = ae, this.valueIsObservable = oe, this.objectGraph = new WeakMap, !V(e)) {
                ...
                this.valueDistortion = Z(t) ? t : ce, this.valueMutated = Z(n) ? n : le, this.valueObserved = Z(i) ? i : ae, this.valueIsObservable = Z(r) ? r : oe
            }
        }
        getProxy(e) {
            const t = X(e),
        ...
        wrapDataInObservable(e) {
            ...
            return function (e, t) {
                ...
                t.watchers[i] ? t.watchers[i].forEach(t => t(e[i])) : Array.isArray(e) ? Object.keys(t.watchers).forEach(n => {
                    let r = n.split(".");
                    "length" !== i && r.reduce((i, r) => (Object.is(e, i[r]) && t.watchers[n].forEach(t => t(e)), i[r]), t.getUnobservedData())
                ...
                switch (i) {
                    ...
                    case "model":
                        ! function (e, t, i, r, s) {
                            ...
                            P(e, t, o, i, `${r} = rightSideOfExpression($event, ${r})`, () => n(n({}, s()), {}, {
                ...
                switch (r) {
                    ...
                    case "if":
                        ...
                        ! function (e, t, n, i, r) {
                            ...
                            if (!n || o && !t.__x_transition) !n && o && y(t.nextElementSibling, () => {
