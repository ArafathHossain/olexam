...
<div class="card mb-4">
    ...
    <div class="card-body">
        <form action="{{ route('admin.live-exams.update', $live_exam->id) }}" method="POST"
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}"
                            id="title" name="title" value="{{ $live_exam->title }}">
                        @if($errors->has('title'))
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control {{ $errors->has('start_time') ? 'is-invalid' : '' }}"
                            id="start_time" name="start_time" value="{{ $live_exam->start_time }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control {{ $errors->has('end_time') ? 'is-invalid' : '' }}"
                            id="end_time" name="end_time" value="{{ $live_exam->end_time }}">
                ...
                <div class="col-md-4 ">
                    <div class="form-group">
                        ...
                        <select class="form-control basic-single {{ $errors->has('main_mcq_id') ? 'is-invalid' : '' }}"
                            name="main_mcq_id">
                            <option value="" disabled="disabled" selected="selected">Select</option>
                            @foreach($mcqs as $key => $mcq)
                            <option value="{{ $mcq->id }}" {{ $live_exam->main_mcq_id == $mcq->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <select
                            ...
                            <option value="{{ $class->id }}"
                                {{$class->id == $live_exam->student_class_id ? 'selected' : '' }}>
                ...
                <div class="col-md-4 ">
                    <div class="form-group">
                        ...
                        <select class="form-control basic-single {{ $errors->has('exam_type') ? 'is-invalid' : '' }}"
                            ...
                            <option value="" disabled="disabled" selected="selected">Select</option>
                            <option value="0" {{ $live_exam->exam_type == 0 ? 'selected' : '' }}>Free</option>
                            <option value="1" {{ $live_exam->exam_type == 1 ? 'selected' : '' }}>Pro</option>
                        </select>
                ...
                <div class="col-md-4 d-none exam_price_content">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}"
                            id="price" name="price" value="{{ $live_exam->price }}">
                        @if ($errors->has('price'))
                            <div class="text-danger">
                                {{ $errors->first('price') }}
                            </div>
