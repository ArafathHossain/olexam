    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">All About</h1>
...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('admin.abouts.create') }}" class="btn btn-success rounded-pill w-100p mb-2 mr-1">
                ...
                <table class="table display table-bordered table-striped table-hover basic">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td >
                                <img src="{{ asset($data->photo) }}" alt="" style="width: 150px">
                            </td>
                            <td>
                                {{$data->title}}
                            </td>
                            ...
                            <td>
                                @php
                                $titles= explode('||',$data->list_title)
                                @endphp
                                <ul>
                            ...
                            <td>
                                ...
                                @can('can-edit')
                                <a href="{{ route('admin.abouts.edit', $data->id) }}"
                                    class="btn btn-info-soft btn-sm mr-1"><i class="far fa-edit"></i></a>
                                @endcan
                                @can('can-delete')
                                <form action="{{ route('admin.abouts.destroy', $data->id) }}" method="POST"
                                    class="d-inline">
