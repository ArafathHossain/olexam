    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">All Subject</h1>
...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('admin.subjects.create') }}" class="btn btn-success rounded-pill w-100p mb-2 mr-1">
                ...
                <table class="table display table-bordered table-striped table-hover basic">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <img width="50px" src="{{ asset('').$subject->photo }}" alt="">
                            </td>
                            <td>
