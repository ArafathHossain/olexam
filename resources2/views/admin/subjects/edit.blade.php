    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Update Subject</h1>
...
<div class="card mb-4">
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h6 class="fs-17 font-weight-600 mb-0">Update Subject</h6>
            </div>
            ...
            <form action="{{ route('admin.subjects.update', $subject->id) }}" method="POST"
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <img width="40px" src="{{ asset(''.$subject->photo) }}" alt="">
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select id="color"
                                ...
                                <option value="{{ $color }}" style="background: rgb({{ $color }})"
                                    {{  $subject->$color == $color ? 'selected' : '' }}></option>
                                @endforeach
                            </select>
                            @if ($errors->has('color'))
                            <div class="text-danger">
